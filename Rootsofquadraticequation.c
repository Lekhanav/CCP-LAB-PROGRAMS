/*This is a C-Program that lets the user enter the coefficients of any quadratic equation.
 Then, it calculates and prints the roots of the quadratic equation. User-defined function has been used in this program.*/
#include <stdio.h>
#include <conio.h>
#include <math.h>
