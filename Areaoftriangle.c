/*This is a program that lets the user enter the three sides of a triangle.
 Then, it calculates and prints the area of the triangle. User-defined function has been used in this program.*/
#include <stdio.h>
#include <conio.h>
#include <math.h>
